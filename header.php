...
?>
	...
	<div class="page-wrapper">
		...
		<div class="top-bar">
			<div class="container">
				...
				<div class="col-md-4 logo" >
					...
					<!--	<div class="list" style="color:#212026">-->
					<!--		<i class="fa fa-envelope"></i> <a href="mailto:<?php echo $contact_email; ?>" style="color:#212026"><?php echo $contact_email; ?></a>-->
					<!--	</div>-->
					<!--	<div class="list" style="color:#212026">-->
		...
		<!-- Header Start -->
		<header  style="background-color:#212026">
			<div class="container">
				<div class="row">
							...
							<ul class="sf-menu" id="menu">
                                ...
                                foreach ($res as $row) {
                                    ...
                                    if($row['page_id'] == 0) {
                                        ...
                                        ?>
                                        <a href="<?php echo $final_url; ?>" style="<?php echo $colorgr; ?>"><?php echo $row['menu_name']; ?><?php if($total) {echo '<em></em>';}; ?></a>
                                        <?php
                                    } else {
                                        ...
                                        foreach ($res1 as $row1) {
                                            ?>
                                            <a href="<?php echo BASE_URL.URL_PAGE.$row1['page_slug']; ?>" style="<?php echo $colorgr; ?>"><?php echo $row1['page_name']; ?><?php if($total) {echo '<em></em>';}; ?></a>
                                            <?php
                                        }
                                    }
