...
.masonry-item {
    ...
    width: 100%; /* Full width to fill the column */
    padding: 20px;
    margin-bottom: 15px;
...
.masonry-itemcolored {
    background: linear-gradient(to right, #ffeaa4 0%, #fdba3b 100%);
    color: black;
    display: inline-block;
    width: 100%; /* Full width to fill the column */
    padding: 20px;
...
@media (max-width: 1200px) {
    .masonry-container {
        column-count: 2; /* 2 columns for medium-sized screens */
    }
}

@media (max-width: 900px) {
    .masonry-container {
        column-count: 1; /* 1 column for smaller screens */
    }
}
...
<section class="service-v1" style="background-color:black">
    ...
    <div class="heading wow fadeInUp">
					<h2 style="text-transform: none; font-family: 'Fraunces', serif; color:white; font-size:50px; color:white !important;"> <span style="color:#ffd64a; font-family: 'Fraunces', serif;">Hear From Our Learners</span></h2>
					<p style="font-size:40px;color:white; font-family: 'Fraunces', serif; margin-top:10px; font-weight:900">TESTIMONIALS</p>
