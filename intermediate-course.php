				...
				<div class="heading wow fadeInUp">
                    ...
                    <div class="row">
                        ...
                        <img class="img-responsive" style="height:32px;width:32px;  position:absolute; top:7px; margin-left:-5px; <?php echo $margint; ?>" src="<?php echo BASE_URL; ?>assets/uploads/file-49.png" alt="">
                            <span style="margin-left:25px; text-align: left; display: block;">Deepen language skills with complex sentence structures, tenses, and professional or cultural vocabulary.</span>
	...
	<div class="container">
		...
		<div class="row" style="margin-top:60px; margin-bottom:60px">
			<div class="col-md-6">
                ...
                Advance Your Hindi Skills Today!<br><br> Enroll Now.
