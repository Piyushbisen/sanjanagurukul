				...
				<div class="heading wow fadeInUp">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="">
                            ...
                            <p class="duration" style="text-align:right; font-weight:600; margin-top:20px; color:white; font-family: 'Fraunces', serif; font-size:25px">
                                <i class="fa fa-play-circle-o" style="font-size:40px; margin-right:5px"></i> 12 weeks 
                            
                                <span class="separator"></span>
                                <i class="fa fa-hourglass-half" style="font-size:40px; margin-right:5px;"></i> 2 classes per week 
                            </p>
                        </div>
                        <div class="col-md-6">
					...
					<p class="about_button" style="margin-top:50px">
						<a style="font-family: 'Fraunces', serif; font-size: 18px; -webkit-transition: all 0.4s ease 0s; -moz-transition: all 0.4s ease 0s; -o-transition: all 0.4s ease 0s; transition: all 0.4s ease 0s; border: 2px solid #ffd64a; color: black; padding: 10px 20px; border-radius: 15px; font-weight: 600; background-color:#ffd64a" href="#" class="btn btn-flat">Enroll Now</a>									
                        <a style="font-family: 'Fraunces', serif; font-size: 18px; -webkit-transition: all 0.4s ease 0s; -moz-transition: all 0.4s ease 0s; -o-transition: all 0.4s ease 0s; transition: all 0.4s ease 0s; border: 2px solid #ffd64a; color: white; padding: 10px 20px; border-radius: 15px; font-weight: 600;" href="#" class="btn btn-flat">Know More</a>									
